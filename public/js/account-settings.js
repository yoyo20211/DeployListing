          ...
          ProfileView = (function(_super) {
            ...
            ProfileView.prototype.initialize = function(options) {
              ...
              this.user.updateProfile = function(user, event) {
                ...
                if (_.isEmpty(_this.user.errors())) {
                  alert('Thank you.');
                } else {
                  alert(JSON.stringify(_this.user.errors()));
                  _this.user.errors.showAllMessages(true);
                }
                return event.preventDefault();
              };
              this.user.cancelUpdateProfile = function(user, event) {
                _this.user.errors.showAllMessages(false);
                ko.cleanNode(jQuery("#personal-info")[0]);
                _this.user = ko.mapping.fromJS(_this.previousProfile, user);
                ko.applyBindings(_this.user, jQuery("#personal-info")[0]);
